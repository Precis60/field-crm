import { useState, useEffect, useRef, useContext, createContext, useMemo, lazy, Suspense } from "react";
...
function PortalShell() {
  ...
  return (
    <Suspense fallback={<div style={{ textAlign: "center", padding: 40, fontFamily: "system-ui", color: "#6B7268" }}>Loading portal…</div>}>
      <PortalApp supabaseClient={supabase} crm={crm} onLogout={() => window.location.reload()} />
    </Suspense>
  );
}
