...
.lp-tabs{position:sticky;top:49px;z-index:4;background:var(--bg);display:flex;gap:6px;padding:12px 16px 0;border-bottom:1px solid var(--line);overflow-x:auto;}
