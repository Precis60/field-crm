  ...
  return (
    <div className="lp-settings lp-settings--wide" style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 160px)", padding: 0, maxWidth: "100%" }}>
      ...
      {loading ? (
        ...
        <div ref={gridRef} className="lp-cal-grid" onSelectStart={(e) => e.preventDefault()} style={{ marginTop: 12, border: "1px solid var(--line)", borderRadius: 12, overflowX: "auto", overflowY: "auto", flex: "1 1 0%", width: "100%", minWidth: 0 }}>
